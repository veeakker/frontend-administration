...
export default class DeliveryKindModel extends Model {
  ...
  get simpleName() {
    const uri = this.uri;
    if (uri == 'http://veeakker.be/delivery-kinds/winkel') return 'winkel';
    if (uri == 'http://veeakker.be/delivery-kinds/toeren') return 'toer';
    if (uri == 'http://veeakker.be/delivery-kinds/natuurwinkels')
      return 'natuurwinkel';
    if (uri == 'http://veeakker.be/delivery-kinds/buurderijen')
      return 'buurderij';
    if (uri == 'http://veeakker.be/delivery-kinds/webshop') return 'webshop';
  ...
  get normalizedLabel() {
    const uri = this.uri;
    if (uri == 'http://veeakker.be/delivery-kinds/winkel') return 'butchery';
    if (uri == 'http://veeakker.be/delivery-kinds/toeren') return 'routes';
    if (uri == 'http://veeakker.be/delivery-kinds/natuurwinkels')
      return 'health-shops';
    if (uri == 'http://veeakker.be/delivery-kinds/buurderijen')
      return 'local-farms';
...
function uriForNormalizedLabel(label) {
  if (label == 'butchery') return 'http://veeakker.be/delivery-kinds/winkel';
  if (label == 'routes') return 'http://veeakker.be/delivery-kinds/toeren';
